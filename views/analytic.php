...
require_once "../store/getStore.php";
...
<div class="recent-orders">
  ...
  <table>
    ...
    <tbody>
  <?php 
 foreach ($fetch_product as $store_product) { ?>
 
<tr>
  <td><img height="35vh" width="10vh"  src="../product_image/<?php echo $store_product['product_image'] ?>" > </td>
  <td><?php echo $store_product['id'] ?></td>
  <td><?php echo $store_product['product_name'] ?></td>
  <td class= "warning"><?php echo $store_product['quality'] ?></td>
  <td class= "primary"><?php echo $store_product['price'] ?></td>
  <td>
      <button type="submit">Edit</button>
      <button type="submit">Delete</button>
  </td>
  <td><?php echo $store_product['status'] ?></td>
</tr>
